...
import com.navideck.gesturedeck.model.GestureState
...
class GesturedeckMapbox(
    ...
    private fun setupGesturesManager(activity: Activity) {
        ...
        androidGesturesManager.setStandardGestureListener(object :
            ...
            override fun onFling(
                ...
                var isValidDistanceCovered: Boolean =
                    distanceCovered in swipeMinValidDistance..swipeMaxValidDistance
                if (!isValidDistanceCovered) return true

                Log.e(
                    TAG,
                    "SwipeGestureRecognizedWith :Distance $distanceCovered | Velocity : ${
                        abs(velocityX)
                    }"
                )
    ...
    private val ShoveGestureDetector.isVerticalGesture: Boolean
        get() {
    ...
    private val ShoveGestureDetector.isHorizontalGesture: Boolean
        get() {
            var swipeDirection: SwipeDirection = this.getSwipeDirection
