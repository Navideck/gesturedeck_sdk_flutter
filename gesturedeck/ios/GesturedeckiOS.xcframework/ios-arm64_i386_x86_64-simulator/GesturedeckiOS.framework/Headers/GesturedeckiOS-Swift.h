...
SWIFT_CLASS("_TtC14GesturedeckiOS33GSTouchesShowingGestureRecognizer")
@interface GSTouchesShowingGestureRecognizer : UIGestureRecognizer <UIGestureRecognizerDelegate>
...
@interface Gesturedeck : NSObject <UIGestureRecognizerDelegate>
